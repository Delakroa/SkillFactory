...
def test_add_new_pet_with_empty_data(name='', animal_type='',
    ...
    """Проверяем что можно добавить питомца с пустыми данными и с фото"""
...
def test_add_new_pet_with_special_characters(name='!#$%&()+,-./:;<=>?@[\]^_`{|}~',
    ...
    """Проверяем что можно добавить питомца со-спец символами"""
...
def test_add_new_pet_with_digital_input(name='0123456789',
                                        animal_type='0123456789',
                                        age='0123456789',
                                        pet_photo='images/kartinki-zajchiki-58.jpg'):
    """Проверяем что можно добавить питомца с цифровым вводом"""
...
def test_add_new_pet_empty_data_without_photo(name='', animal_type='', age=''):
    """Проверяем что можно добавить питомца с пустыми данными без фото"""
    # Во всех питомцах пустую плашку видно, в моих питомцах не отображается!
